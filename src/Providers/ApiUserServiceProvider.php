...
namespace Sudo\ApiUser\Providers;
...
class ApiUserServiceProvider extends ServiceProvider
{
     ...
     */
    protected $middleare = [
        'auth-api' => '\Sudo\ApiUser\Http\Middleware\ApiAuthenticate',
    ];
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/api_users');
            $this->publishes($assets, 'sudo/api_users/assets');
            $this->publishes($config, 'sudo/api_users/config');
